...
local function main()
    ...
    Explorer.ShowRightClick = function(MousePos)
        ...
        context:AddRegistered("SEND_TELEGRAM") -- Added Telegram Action Here
    ...
    Explorer.InitRightClick = function()
        ...
        -- SEND TO TELEGRAM REGISTER
        context:Register("SEND_TELEGRAM",{Name = "Send to Telegram", IconMap = Explorer.MiscIcons, Icon = "Reference", OnClick = function()
            local sList = selection.List
            local htmlParts = {}
            ...
            for i, v in ipairs(sList) do
                ...
                local knownProps = {
                    ...
                    "Texture", "Image", "SoundId", "Volume", "PlaybackSpeed", "Looped"
                }
                ...
                table.insert(htmlParts, string.format(
                    "<b>Instance:</b> %s\n<b>Class:</b> %s\n%s",
                    escapeHtml(fullName), escapeHtml(className), propsText
                ))
            end
